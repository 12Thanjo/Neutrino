...
var Compiler = function(input, const_dict, config){
	...
	if(input.type == "program"){
		var output = "if(globalThis.process!=null){process.neutrino_legacy_mode="+JSON.stringify(config.legacy)+";}else{window.neutrino_legacy_mode="+JSON.stringify(config.legacy)+";};";
